        ...
        <div className="flex h-screen flex-col">
            ...
            <div className="border-b bg-background/95 p-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <h1 className="text-2xl font-bold tracking-tight">
                    <span className="bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-transparent">Bagan 1 - Quarter Final → Final</span>
                </h1>
                <p className="text-sm text-muted-foreground">View Only - Quarter Final → Semi Final → Final → Champion</p>
            </div>
